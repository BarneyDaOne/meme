...
let curxp = xp[item.author.id + item.member.guild.id].xp;
let hiddenxp = xp[item.author.id + item.member.guild.id].oxp;
...
setTimeout(() => {
  ...
  xp[item.author.id + item.member.guild.id].xp = curxp += xpAdd;
  xp[item.author.id + item.member.guild.id].oxp = hiddenxp += xpAd;
  talkedRecently.delete(item.author.id);
}, 25000);

if (nxtLvl < xp[item.author.id + item.member.guild.id].oxp) {
  xp[item.author.id + item.member.guild.id].oxp = 0;
    
  xp[item.author.id + item.member.guild.id].level = curlvl + 1;
